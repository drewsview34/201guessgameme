...
//Q7
var favoriteColor = ['BLUE', 'BABY BLUE', 'GRAY', 'GREY', 'BLACK'];
console.log ('favoriteColor', favoriteColor);
var userColorGuess = prompt('What\'s my favorite colors?').toUpperCase;
console.log('userColorGuess', userColorGuess);

while (userColorGuess !== 34 && numberOfTries < 6) {
...
if (userColorGuess === [0, 1, 2, 3] && j < 4) {
  alert('You\'re correct! That\'s one of them.');
} else {
  alert('Too bad. You\'re out of tries.');
}
// alert('What\'s my favorite color?');

// var userColor = (prompt('guess a number I am thinking of between 1 and 100'));
// if (userColor === 'Y' || userColor === 'YES') {
//   alert('I am! That\'s how I\'m learning all this cool stuff.');
// } else {
//   alert('Incorrect, I\'m obviously a beginner.');}
